...
export const FIREBASE_MESSAGE_DELETE_LOADING ='FIREBASE_MESSAGE_DELETE_LOADING';
export const FIREBASE_MESSAGE_DELETE_SUCCESS ='FIREBASE_MESSAGE_DELETE_SUCCESS';
export const FIREBASE_MESSAGE_DELETE_FAILURE ='FIREBASE_MESSAGE_DELETE_FAILURE';
...
export const GET_FIREBASE_CHATS_LOADING ='GET_FIREBASE_CHATS_LOADING';
export const GET_FIREBASE_CHATS_SUCCESS ='GET_FIREBASE_CHATS_SUCCESS';
export const GET_FIREBASE_CHATS_FAILURE ='GET_FIREBASE_CHATS_FAILURE';